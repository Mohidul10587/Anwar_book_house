  ...
  return (
    <div className="min-h-screen pt-24">
      <div className="flex justify-center px-2">
        <form
          className="border border-gray-400 bg-violet-400 rounded md:w-1/2 p-10"
        ...
        >
          ...
          <button
            className=" p-2  bg-violet-600 hover:bg-violet-700 text-white rounded mt-4 w-full flex items-center justify-center"
            type="submit"
          >
            Reset Password
          </button>
