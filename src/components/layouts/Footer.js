  ...
  return (
    <>
      <div className="hidden sm:block ">
        <div className="flex p-3 bg-primary w-full ">
          ...
          <div className="w-1/2 px-6 pt-6">
            <div className="text-gray-400">
              ...
              <p className="w-24 h-0.5 bg-red-600 mt-4 mb-4"></p>
        ...
        <div className="bg-primary w-full text-white text-center py-3 border-t">
          <p>
            © Copyright By<span className="italic"> Md Anwar</span>
          </p>
        </div>
      </div>

      <div className="fixed border-t border-gray-600 sm:hidden bottom-0 h-11 z-30 w-full bg-white px-8  flex items-center justify-between">
        <p>
          <Link href="/">
            {" "}
        ...
        <p>
          <Link href="/sellers_interaction/cart">
            {" "}
